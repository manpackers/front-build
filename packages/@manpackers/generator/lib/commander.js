...
const inital = version =>
  commander
    .version(version)
    .usage('<command> [option]')
    .option('--ic, [file:string]', 'Initialize config item at compile time.', '.manpackeric')
    .option('-c, --config [file:string]', 'The root (current project) settings config file.', './manpacker.webpack.js')
    .option('-r, --root [file:string]', 'Construction engineering project root directory.')
